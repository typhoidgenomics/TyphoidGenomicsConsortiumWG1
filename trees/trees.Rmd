...
## load tree link data
``` {r}
t232 <- read.tree("pathogenwatch-styphi-pvmrvujfye41-typhi-232-plus-ingle-2021-for-outgrouping-collection-tree__2.3.2_ingroup.nwk")
...
tree_232_plot <- ggtree(as.treedata(treedat_232)) + 
  ...
  geom_tippoint(aes(color = Region, shape=cipIR)) +
...
## Fig S4: Pathogenwatch tree of 2.3.2 isolates
``` {r, eval=F}
